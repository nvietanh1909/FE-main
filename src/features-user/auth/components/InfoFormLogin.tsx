...
export default function InfoFormLogin() {
    return (
        <div className="relative w-[947.74px] h-full flex items-center justify-center overflow-hidden bg-gradient-to-br from-[#146DA8] to-[#0E3454]">
                ...
                <img src={LoginImg} alt="Login Illustration" className="absolute left-1/2 bottom-[120px] -translate-x-1/2 w-[420px] max-w-[90%] z-[3] opacity-95 pointer-events-none select-none" />
